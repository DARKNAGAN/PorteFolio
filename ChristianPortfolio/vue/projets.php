		<div id="projet" class="container-fluid bg-1">
			<br><br><center><h3>PROJETS</h3></center><br>
				...
				<center><div class="row" id="accordion">
					<div class="col-6 col-sm-6">
						...
						<div class="col-3 col-sm-6">
							<ul class="list-unstyled">
								...
								<li class="media my-4">
									...
									<div class="media-body">
										...
										<div id="collapseProTwo" class="collapse" aria-labelledby="headingProTwo" data-parent="#accordion">
											<div class="card-body">
												Site web en HTML / CSS et PHP / JavaScript / SQL.<br>
												- Site web avec CMS (WordPress).<br>
												- Site web avec Frameworks (Bootsrap, Django).<br>
												- Site web avec l'utilisation d'API.<br>
											</div>
										</div>									
									</div>
								</li>
								...
								<li class="media">
									<img class="mr-3" src="./images/projet/APPLICATION.jpg" alt="Developpement Applicatif" style="width:100%;">
									<div class="media-body">
										<h5 class="mt-0 mb-1">Développement d'applications client lourd</h5>
						...
						<div class="col-3 col-sm-6">
							<ul class="list-unstyled">
								...
								<li class="media">
									<img class="mr-3" src="./images/projet/FROID.jpg" alt="Systeme climatique" style="width:100%;">
									<div class="media-body">
										<h5 class="mt-0 mb-1">Installation, maintenance et dépannage de systèmes de climatisation</h5>
										<div class="card-header" id="headingProSept">
											<h4 class="mb-0">
												<a data-toggle="collapse" data-target="#collapseProSept" aria-expanded="true" aria-controls="collapseProSept">
												  <span class="glyphicon glyphicon-chevron-down"></span>
												</a>
											</h4>
										</div>
										<div id="collapseProSept" class="collapse" aria-labelledby="headingProSept" data-parent="#accordion">
											<div class="card-body">
												-	Etablir un diagnostic pour remédier aux problèmes de fonctionnement dans le cadre d'un dépannage.
											</div>
										</div>								
									</div>
								</li>
								<li class="media">
									...
									<div class="media-body">
										...
										<div id="collapseProSix" class="collapse" aria-labelledby="headingProSix" data-parent="#accordion">
											<div class="card-body">
												- Contrôle et réalisation d'opération de maintenance sur des équipements d'impression automatisés.
											</div>
										</div>								
									</div>
								</li>
					...
					<div class="col-6 col-sm-6">
						...
						<div class="col-3 col-sm-6">
							<ul class="list-unstyled">
								<li class="media my-4">
									<img class="mr-3" src="./images/projet/RASPBERRY.jpg" alt="Raspberry" style="width:100%;">
									<div class="media-body">
										...
										<div id="collapsePersoOne" class="collapse" aria-labelledby="headingPersoOne" data-parent="#accordion">
											<div class="card-body">
											 - Réalisation d'un projet électronique Kuman Kits K66. 
											</div>
										</div>									
									</div>
								</li>
								<li class="media my-4">
									<img class="mr-3" src="./images/projet/ADOBE.jpg" alt="Adobe CC 2017" style="width:100%;">
									<div class="media-body">
										<h5 class="mt-0 mb-1">Adobe CC 2017: Création graphique</h5>
						...
						<div class="col-3 col-sm-6">
							<ul class="list-unstyled">
								<li class="media">
									<img class="mr-3" src="./images/projet/PORTFOLIO.png" alt="Portfolio" style="width:100%;">
									<div class="media-body">
										<h5 class="mt-0 mb-1">Réalisation d'un Portfolio personnel</h5>
										...
										<div id="collapsePersoThree" class="collapse" aria-labelledby="headingPersoThree" data-parent="#accordion">
											<div class="card-body">
												- Réalisation d'un portfolio,	<br>
													Langage : PHP/HTML/CSS.<br>
													Template : W3Schools / Bootstrap / JQuery.<br>
													API : Spotify / MyAnimeList (Jikan) / TheMovieDataBase / (Steam) > Playnite.<br>
												L'objectif est de me présenter moi ainsi que mes projets.<br>
												Dans un second temps il me permet de développer et centraliser les réseaux sociaux et mes points d'intérêts.<br>
												Il se construira au fil du temps et de ma carrière !
											</div>									  
										</div>									
									</div>
								</li>
