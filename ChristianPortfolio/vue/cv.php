		<div id="cv" class="container-fluid bg-1 "><br><br>
			<h1 class="w3-center">CURRICULUM VITAE</h1><br>			
				...
				<div class="w3-row-padding">	<!-- The Grid -->				
					<div class="w3-third">	<!-- Left Column -->
						<div class="w3-container w3-white w3-text-grey w3-card-4">
							<h1 class="w3-center">Christian<br>CUNAT-BRULÉ</h1><hr>
							<h5 class="w3-center"><b>Ingénieur développeur informatique</b></h5><hr>
							<p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i>Etudiant / Informaticien</p>
							...
							<p><i class="fa fa-at fa-fw w3-margin-right w3-large w3-text-teal"></i>ccunatbrule.free.fr</p>
							<p><i class="w3-margin-right w3-large w3-text-teal"></i>22 ans - Permis - Véhicule</p>
						</div><hr>
						<div class="w3-container w3-white w3-text-grey w3-card-4">
					...
					<div class="w3-twothird">	<!-- Right Column -->
						<div class="w3-container w3-card w3-white w3-card-4 w3-margin-bottom">
							...
							<div class="w3-container">
								...
								-	Développement logiciel dans un outil de gestion de portefeuilles de projets dans l'outil SharePoint.<br>
								-	Réalisation de fonctionnalités dans l'outil Excel et PowerPoint et développement de macro.</p>								
							</div>
							<div class="w3-container">
						...
						<div class="w3-white w3-text-grey w3-card-4">
							<div class="w3-container">
								...
								<div class="w3-container w3-quarter">
									...
									<p>Équitation galop 4</p><p>Salle de sport</p><p>Course à pied</p>
								</div>
								<div class="w3-container w3-quarter">
									<h5><i class="fa fa-newspaper-o w3-margin-right w3-xxlarge w3-text-teal"></i><b>Hoobies</b></h5>								
									<p>Actualité numérique</p><p>Electronique / Informatique</p><p>Audiophile</p><p>Piano en Autodidacte</p>
								</div>
								<div class="w3-container w3-quarter">
									<h5><i class="fa fa-gamepad w3-margin-right w3-xxlarge w3-text-teal"></i><b>Multimédia</b></h5>								
									<p>Film et série - Animé</p><p>Livre - Light novel</p><p>Jeu vidéo - Action/Aventure</p><p>Musique - Rock/Métal</p>
								</div>
								<div class="w3-container w3-quarter">
