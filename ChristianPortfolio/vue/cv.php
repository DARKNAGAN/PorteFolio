		...
		<!--	<h3 class="text-center mb-3">Recherche contrat</h3>-->
						...
						<div class="row justify-content-center">
							...
							<div class="container card mb-3" tabindex="0">
								<h2 class="text-center m-3">Christian<br>CUNAT-BRULÉ</h2>
								<p><i class="fa fa-home fa-md mr-3 text-teal"></i>Essonne, France</p>
								<p><i class="fa fa-phone fa-md mr-3 text-teal"></i>07.67.76.36.34</p>
								<p><i class="fa fa-envelope fa-md mr-3 text-teal"></i>ccunatbrule@gmail.com</p>
								<p><i class="fa fa-at fa-md mr-3 text-teal"></i>ccunatbrule.free.fr</p>
								<p class="text-center"><i class="text-teal"></i>22 ans - Permis - Véhiculé</p>
							</div>
							<div class="container card mb-3"><!-- Competence Column -->
							<h5 class="text-dark p-3" tabindex="0"><i class="fa fa-sliders-h fa-lg mr-3 text-teal"></i>Compétences</h5>
								...
								<div class="row">
									<div class="col" tabindex="0">
										<h6><strong><i class="fa fa-globe-europe fa-lg mr-3 text-teal"></i>Langues</strong></h6>
								<div class="row text-center p-2">
								<div class="col">
								<p><strong>Français</strong><br>Bilingue (C2)</p>
									</div><div class="col">
										<p><strong>Anglais</strong><br>Notions (A2)</p>
									</div>
								</div>
									</div>
								</div>
								...
								<div class="row justify-content-between">
									<div class="col-auto">
										<p>Visual Basic 2010 Express<br>Eclipse | Code::Blocks | Bash<br>Android Studio | DevTools Web</p>
									</div><div class="col-auto text-right" aria-label="Niveau autonome">
										<i class="fa fa-star checked"></i>
									</div>
								</div>
								...
								<div class="row justify-content-between">
									<div class="col-auto">
										<p>Microsoft Office | Adobe CS6 Design<br>NotPad++ | vi | Git GLPI | OCS</p>
									</div><div class="col-auto text-right" aria-label="Niveau confirmé">
										<i class="fa fa-star checked"></i><i class="fa fa-star checked"></i>
									</div>
								</div>
								...
								<div class="row justify-content-between"><div class="col-auto">
										<p>VMware | VirtualBox | Packet Tracer<br>WampServer | XAMPP<br>Putty | Wireshark | FileZilla <br> HPE IMC | Junos | Cisco IOS</p>
									</div><div class="col-auto text-right" aria-label="Niveau autonome">
										<i class="fa fa-star checked"></i>
									</div>
								</div>
								<div class="row justify-content-between">
									<div class="col-auto">
										<p>Linux | Windows | Android | MacOS <br> Cisco | HP | 3Com | Juniper<br>Polycom | IPBX</p>
									</div><div class="col-auto text-right" aria-label="Niveau autonome">
										<i class="fa fa-star checked"></i>
									</div>
								</div>
						...
						<div class="col-auto">
							<div class="container card mb-3" tabindex="0"><!-- Pro Column -->
								...
								<div class="container">
									...
									<h6><strong>Apprenti Assistant à Maîtrise d'Ouvrage</strong></h6>
								...
								<div class="container">
									...
									<h6><strong>Apprenti Assistant Développeur</strong></h6>
								...
								<div class="container">
									...
									<h6><strong>Apprenti Monteur Électricien</strong></h6>
							...
							<div class="container card mb-2"><!-- Divers Column -->
								<h5 class="text-dark p-3" tabindex="0"><i class="fa fa-info-circle fa-lg mr-3 text-teal"></i>Divers connaissances</h5>
								<div class="row m-2">
					...
					<div class="container text-center card mb-3" tabindex="0"><!-- Bottom Column -->
						<h5 class="text-dark p-3"><i class="far fa-star fa-lg mr-3 text-teal"></i>Centres d'intérêt</h5>
							<div class="row m-2">
